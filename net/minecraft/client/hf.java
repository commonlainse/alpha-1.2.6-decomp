...
extends lw {
    ...
    protected void c(float f2) {
        ...
        if (n2 > 0) {
            this.a(null, n2);
            int n3 = this.as.a(fi.b(this.aw), fi.b(this.ax - (double)0.2f - (double)this.aO), fi.b(this.ay));
            if (n3 > 0) {
                bi bi2 = nq.m[n3].bq;
    ...
    public void b(float f2, float f3) {
        ...
        float f6 = fi.a(d4 * d4 + d5 * d5) * 4.0f;
        if (f6 > 1.0f) {
            f6 = 1.0f;
        }
    ...
    public boolean D() {
        ...
        int n3;
        int n4 = fi.b(this.aw);
        return this.as.a(n4, n3 = fi.b(this.aG.b), n2 = fi.b(this.ay)) == nq.aF.bh || this.as.a(n4, n3 + 1, n2) == nq.aF.bh;
    }

    @Override
    public void a(iq iq2) {
        iq2.a("Health", (short)this.J);
        iq2.a("HurtTime", (short)this.L);
        iq2.a("DeathTime", (short)this.O);
        iq2.a("AttackTime", (short)this.P);
    }
    ...
    public void b(iq iq2) {
        ...
        this.L = iq2.d("HurtTime");
        this.O = iq2.d("DeathTime");
        this.P = iq2.d("AttackTime");
    }
    ...
    public aoclass e(float f2) {
        if (f2 == 1.0f) {
            return aoclass.b(this.aw, this.ax, this.ay);
        }
    ...
    public aoclass f(float f2) {
        if (f2 == 1.0f) {
            float f3 = fi.b(-this.aC * ((float)Math.PI / 180) - (float)Math.PI);
            float f4 = fi.a(-this.aC * ((float)Math.PI / 180) - (float)Math.PI);
            float f5 = -fi.b(-this.aD * ((float)Math.PI / 180));
            float f6 = fi.a(-this.aD * ((float)Math.PI / 180));
            return aoclass.b(f4 * f5, f6, f3 * f5);
        }
        ...
        float f11 = -fi.b(-f7 * ((float)Math.PI / 180));
        float f12 = fi.a(-f7 * ((float)Math.PI / 180));
        return aoclass.b(f10 * f11, f12, f9 * f11);
    }

    public nx a(double d2, float f2) {
        aoclass ao2 = this.e(f2);
        aoclass ao3 = this.f(f2);
