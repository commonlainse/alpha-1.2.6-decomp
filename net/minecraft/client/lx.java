...
extends dl {
                    ...
                    for (n9 = n10; !bl4 && n9 < n11; ++n9) {
                        for (int i2 = n14; !bl4 && i2 < n15; ++i2) {
                            for (int i3 = n13 + 1; !bl4 && i3 >= n12 - 1; --i3) {
                                ...
                                if (byArray[n8] == nq.A.bh || byArray[n8] == nq.B.bh) {
                                    bl4 = true;
                                }
                            ...
                            for (n8 = n14; n8 < n15; ++n8) {
                                ...
                                for (int i4 = n13 - 1; i4 >= n12; --i4) {
                                    ...
                                    if (d16 > -0.7 && d14 * d14 + d16 * d16 + d15 * d15 < 1.0) {
                                        ...
                                        if (by2 == nq.t.bh || by2 == nq.v.bh || by2 == nq.u.bh) {
                                            if (i4 < 10) {
                                                byArray[n16] = (byte)nq.C.bh;
                                            } else {
                                                byArray[n16] = 0;
                                                if (bl5 && byArray[n16 - 1] == nq.v.bh) {
                                                    byArray[n16 - 1] = (byte)nq.u.bh;
                                                }
                                            }
                                        }
                                    }
    ...
    protected void a(cy cy2, int n2, int n3, int n4, int n5, byte[] byArray) {
        int n6 = this.b.nextInt(this.b.nextInt(this.b.nextInt(40) + 1) + 1);
        if (this.b.nextInt(15) != 0) {
            n6 = 0;
        }
        for (int i2 = 0; i2 < n6; ++i2) {
            double d2 = n2 * 16 + this.b.nextInt(16);
            double d3 = this.b.nextInt(this.b.nextInt(120) + 8);
            ...
            for (int i3 = 0; i3 < n7; ++i3) {
                ...
                this.a(n4, n5, byArray, d2, d3, d4, f4, f2, f3, 0, 0, 1.0);
            }
        }
    }
}
