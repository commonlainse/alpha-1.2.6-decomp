...
implements pk {
    ...
    public static iq a(File file, String string) {
        ...
        if (file4.exists()) {
            try {
                iq iq2 = ab.a(new FileInputStream(file4));
                iq iq3 = iq2.k("Data");
                return iq3;
            }
    ...
    public cy(File file, String string) {
        this(file, string, new Random().nextLong());
    }

    public cy(String string, oz oz2, long l2) {
        this.w = string;
        this.u = l2;
        this.q = oz2;
        oz2.a(this);
    ...
    public cy(File file, String string, long l2) {
     ...
     */
    public cy(File file, String string, long l2, oz oz2) {
        Object object;
        Object object2;
        this.s = file;
        this.w = string;
        ...
        if (((File)object).exists()) {
            try {
                iq iq2 = ab.a(new FileInputStream((File)object));
                iq iq3 = iq2.k("Data");
                this.u = iq3.f("RandomSeed");
                this.m = iq3.e("SpawnX");
                this.n = iq3.e("SpawnY");
                this.o = iq3.e("SpawnZ");
                this.e = iq3.f("Time");
                this.v = iq3.f("SizeOnDisk");
                if (iq3.b("Player")) {
                    this.H = iq3.k("Player");
                    int n2 = this.H.e("Dimension");
                    if (n2 == -1) {
                        object2 = new om();
                    }
                }
    ...
    private void p() {
        ...
        this.n();
        iq iq3 = new iq();
        iq3.a("RandomSeed", this.u);
        iq3.a("SpawnX", this.m);
        iq3.a("SpawnY", this.n);
        iq3.a("SpawnZ", this.o);
        iq3.a("Time", this.e);
        iq3.a("SizeOnDisk", this.v);
        iq3.a("LastPlayed", System.currentTimeMillis());
        eb eb2 = null;
        if (this.d.size() > 0) {
            eb2 = (eb)this.d.get(0);
        }
    ...
    public void a(ch ch2, int n2, int n3, int n4, int n5) {
        ...
        } else if (ch2 == ch.Block && nq.s[n6 = this.a(n2, n3, n4)] > n5) {
            n5 = nq.s[n6];
        }
    ...
    public nx a(aoclass ao2, aoclass ao3, boolean bl2) {
        if (Double.isNaN(ao2.a) || Double.isNaN(ao2.b) || Double.isNaN(ao2.c)) {
            return null;
        }
        if (Double.isNaN(ao3.a) || Double.isNaN(ao3.b) || Double.isNaN(ao3.c)) {
            return null;
        }
        int n2 = fi.b(ao3.a);
        int n3 = fi.b(ao3.b);
        ...
        while (n8-- >= 0) {
            ...
            double d6 = 999.0;
            double d7 = 999.0;
            double d8 = ao3.a - ao2.a;
            double d9 = ao3.b - ao2.b;
            double d10 = ao3.c - ao2.c;
            if (d2 != 999.0) {
                d5 = (d2 - ao2.a) / d8;
            }
            if (d3 != 999.0) {
            ...
            aoclass ao4 = ao2.b(ao2.a, ao2.b, ao2.c);
            ao4.a = fi.b(ao2.a);
            n5 = (int)ao4.a;
            if (n9 == 5) {
                --n5;
    ...
    public boolean a(lw lw2) {
        int n2 = fi.b(lw2.aw / 16.0);
        int n3 = fi.b(lw2.ay / 16.0);
        boolean bl2 = false;
        if (lw2 instanceof eb) {
            bl2 = true;
        }
        if (bl2 || this.g(n2, n3)) {
            if (lw2 instanceof eb) {
    ...
    public List a(lw lw2, co co2) {
        this.I.clear();
        int n2 = fi.b(co2.a);
        int n3 = fi.b(co2.d + 1.0);
        int n4 = fi.b(co2.b);
        int n5 = fi.b(co2.e + 1.0);
        int n6 = fi.b(co2.c);
        int n7 = fi.b(co2.f + 1.0);
        for (int i2 = n2; i2 < n3; ++i2) {
            for (int i3 = n6; i3 < n7; ++i3) {
                if (!this.d(i2, 64, i3)) continue;
                for (int i4 = n4 - 1; i4 < n5; ++i4) {
                    nq nq2 = nq.m[this.a(i2, i4, i3)];
    ...
    public int a(float f2) {
        float f3 = this.b(f2);
        float f4 = 1.0f - (fi.b(f3 * (float)Math.PI * 2.0f) * 2.0f + 0.5f);
        if (f4 < 0.0f) {
            f4 = 0.0f;
        }
        if (f4 > 1.0f) {
    ...
    public aoclass a(lw lw2, float f2) {
        float f3 = this.b(f2);
        float f4 = fi.b(f3 * (float)Math.PI * 2.0f) * 2.0f + 0.5f;
        if (f4 < 0.0f) {
            f4 = 0.0f;
        }
        if (f4 > 1.0f) {
        ...
        return aoclass.b(f6 *= f4, f7 *= f4, f8 *= f4);
    }
    ...
    public aoclass c(float f2) {
        ...
        return aoclass.b(f5 *= f4 * 0.9f + 0.1f, f6 *= f4 * 0.9f + 0.1f, f7 *= f4 * 0.85f + 0.15f);
    }

    public aoclass d(float f2) {
        float f3 = this.b(f2);
    ...
    public int e(int n2, int n3) {
        ...
        while (n4 > 0) {
            ...
            if (n5 == 0 || !nq.m[n5].bs.c() && !nq.m[n5].bs.d()) {
                --n4;
                continue;
            }
            return n4 + 1;
    ...
    public float e(float f2) {
        float f3 = this.b(f2);
        float f4 = 1.0f - (fi.b(f3 * (float)Math.PI * 2.0f) * 2.0f + 0.75f);
        if (f4 < 0.0f) {
            f4 = 0.0f;
        }
        if (f4 > 1.0f) {
    ...
    public void h(int n2, int n3, int n4, int n5) {
        ...
        if (this.a) {
            ...
            if (this.a(kq2.a - n6, kq2.b - n6, kq2.c - n6, kq2.a + n6, kq2.b + n6, kq2.c + n6) && (n7 = this.a(kq2.a, kq2.b, kq2.c)) == kq2.d && n7 > 0) {
                nq.m[n7].a(this, kq2.a, kq2.b, kq2.c, this.l);
            }
            return;
        }
        if (this.a(n2 - n6, n3 - n6, n4 - n6, n2 + n6, n3 + n6, n4 + n6)) {
            if (n5 > 0) {
                kq2.a((long)nq.m[n5].d() + this.e);
            }
    ...
    public void a(lw lw2, boolean bl2) {
        ...
        int n5 = fi.b(lw2.aw / 16.0);
        int n6 = fi.b(lw2.ax / 16.0);
        int n7 = fi.b(lw2.ay / 16.0);
        ...
        for (int i2 = n2; i2 < n3; ++i2) {
            for (int i3 = n4; i3 < n5; ++i3) {
                for (int i4 = n6; i4 < n7; ++i4) {
                    ...
                    if (n8 != nq.ar.bh && n8 != nq.C.bh && n8 != nq.D.bh) continue;
                    return true;
                }
            }
        }
    ...
    public float a(aoclass ao2, co co2) {
    ...
    protected void j() {
        ...
        for (int i2 = 0; i2 < this.d.size(); ++i2) {
            Object object = (eb)this.d.get(i2);
            n5 = fi.b(((eb)object).aw / 16.0);
            n4 = fi.b(((eb)object).ay / 16.0);
            int n6 = 9;
            for (n3 = -n6; n3 <= n6; ++n3) {
                for (n2 = -n6; n2 <= n6; ++n2) {
        ...
        for (Object object : this.K) {
            ...
            for (n3 = 0; n3 < 80; ++n3) {
                ...
                if (!nq.n[by2]) continue;
                nq.m[by2].a(this, n9 + n5, n7, n8 + n4, this.l);
            }
        }
    }
    ...
    public boolean a(boolean bl2) {
        ...
        for (int i2 = 0; i2 < n2; ++i2) {
            ...
            nq.m[n3].a(this, kq2.a, kq2.b, kq2.c, this.l);
        }
    ...
    public void m(int n2, int n3, int n4) {
        ...
        for (int i2 = 0; i2 < 1000; ++i2) {
            ...
            if (n9 <= 0) continue;
            nq.m[n9].b(this, n8, n7, n6, random);
        }
    }

    public List b(lw lw2, co co2) {
        this.M.clear();
        int n2 = fi.b((co2.a - 2.0) / 16.0);
        int n3 = fi.b((co2.d + 2.0) / 16.0);
        int n4 = fi.b((co2.c - 2.0) / 16.0);
        int n5 = fi.b((co2.f + 2.0) / 16.0);
        for (int i2 = n2; i2 <= n3; ++i2) {
            for (int i3 = n4; i3 <= n5; ++i3) {
                if (!this.g(i2, i3)) continue;
    ...
    public boolean a(int n2, int n3, int n4, int n5, boolean bl2) {
        ...
        if (nq2 == nq.A || nq2 == nq.B || nq2 == nq.C || nq2 == nq.D || nq2 == nq.ar || nq2 == nq.aS) {
            return true;
        }
    ...
    public boolean j(int n2, int n3, int n4, int n5) {
        ...
        return nq.m[n6].c(this, n2, n3, n4, n5);
    }
    ...
    public boolean k(int n2, int n3, int n4, int n5) {
        ...
        return nq.m[n6].c((pk)this, n2, n3, n4, n5);
    }
    ...
    public eb a(lw lw2, double d2) {
        return this.a(lw2.aw, lw2.ax, lw2.ay, d2);
    }

    public eb a(double d2, double d3, double d4, double d5) {
        double d6 = -1.0;
        eb eb2 = null;
        for (int i2 = 0; i2 < this.d.size(); ++i2) {
            eb eb3 = (eb)this.d.get(i2);
    ...
    public boolean a(eb eb2, int n2, int n3, int n4) {
        return true;
    }
