...
extends Panel {
    public CrashDialog(hr hr2) {
        this.setBackground(new Color(3028036));
        this.setLayout(new BorderLayout());
        StringWriter stringWriter = new StringWriter();
        hr2.b.printStackTrace(new PrintWriter(stringWriter));
        ...
        try {
            ...
            string3 = string3 + "OpenGL: " + GL11.glGetString(7937) + " version " + GL11.glGetString(7938) + ", " + GL11.glGetString(7936) + "\n";
        }
        ...
        this.add((Component)new _do(), "North");
        this.add((Component)new ow(80), "East");
        this.add((Component)new ow(80), "West");
        this.add((Component)new ow(100), "South");
