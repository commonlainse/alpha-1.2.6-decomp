    ...
    protected void b_() {
        ...
        if (!(this.h || this.g == null || this.a != null && this.bd.nextInt(20) != 0)) {
            ...
            for (int i2 = 0; i2 < 10; ++i2) {
                int n5;
                int n6;
                int n7 = fi.b(this.aw + (double)this.bd.nextInt(13) - 6.0);
                float f5 = this.a(n7, n6 = fi.b(this.ax + (double)this.bd.nextInt(7) - 3.0), n5 = fi.b(this.ay + (double)this.bd.nextInt(13) - 6.0));
                if (!(f5 > f4)) continue;
                f4 = f5;
                n3 = n7;
                n2 = n6;
        ...
        aoclass ao2 = this.a.a(this);
        double d2 = this.aP * 2.0f;
        while (ao2 != null && ao2.d(this.aw, ao2.b, this.ay) < d2 * d2) {
            this.a.a();
            if (this.a.b()) {
                ao2 = null;
                this.a = null;
        ...
        if (ao2 != null) {
            float f6;
            double d3 = ao2.a - this.aw;
            double d4 = ao2.c - this.ay;
            double d5 = ao2.b - (double)n8;
            ...
            if (this.h && this.g != null) {
                ...
                this.ah = -fi.a(f6) * this.ai * 1.0f;
                this.ai = fi.b(f6) * this.ai * 1.0f;
            }
            if (d5 > 0.0) {
                this.ak = true;
            }
