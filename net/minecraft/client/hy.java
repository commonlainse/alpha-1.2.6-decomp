...
extends js {
    ...
    public boolean a(cy cy2, Random random, int n2, int n3, int n4) {
        if (cy2.f(n2, n3, n4) != hb.f) {
            return false;
        }
        float f2 = random.nextFloat() * (float)Math.PI;
        double d2 = (float)(n2 + 8) + fi.a(f2) * (float)this.b / 8.0f;
        double d3 = (float)(n2 + 8) - fi.a(f2) * (float)this.b / 8.0f;
        double d4 = (float)(n4 + 8) + fi.b(f2) * (float)this.b / 8.0f;
        double d5 = (float)(n4 + 8) - fi.b(f2) * (float)this.b / 8.0f;
        ...
        for (int i2 = 0; i2 <= this.b; ++i2) {
            ...
            double d12 = (double)(fi.a((float)i2 * (float)Math.PI / (float)this.b) + 1.0f) * d11 + 1.0;
            double d13 = (double)(fi.a((float)i2 * (float)Math.PI / (float)this.b) + 1.0f) * d11 + 1.0;
            for (int i3 = (int)(d8 - d12 / 2.0); i3 <= (int)(d8 + d12 / 2.0); ++i3) {
                for (int i4 = (int)(d9 - d13 / 2.0); i4 <= (int)(d9 + d13 / 2.0); ++i4) {
                    for (int i5 = (int)(d10 - d12 / 2.0); i5 <= (int)(d10 + d12 / 2.0); ++i5) {
                        ...
                        if (!(d14 * d14 + d15 * d15 + d16 * d16 < 1.0) || (n5 = cy2.a(i3, i4, i5)) != nq.E.bh) continue;
