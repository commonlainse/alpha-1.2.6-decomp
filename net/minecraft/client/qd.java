...
implements hi {
    ...
    public void J() {
        for (int i2 = 0; i2 < this.c(); ++i2) {
            ...
            while (fp2.a > 0) {
                ...
                fp2.a -= n2;
                eo eo2 = new eo(this.as, this.aw + (double)f2, this.ax + (double)f3, this.ay + -0.0, new fp(fp2.c, n2, fp2.d));
                float f5 = 0.05f;
    ...
    public void e_() {
        ...
        if (this.as.a(n4, n3, n2) == nq.aG.bh) {
            ...
            double d11;
            double d12;
            aoclass ao2 = this.h(this.aw, this.ax, this.ay);
            ...
            this.d(d12, 0.0, d11);
            if (nArray[0][1] != 0 && fi.b(this.aw) - n4 == nArray[0][0] && fi.b(this.ay) - n2 == nArray[0][2]) {
                this.b(this.aw, this.ax + (double)nArray[0][1], this.ay);
            } else if (nArray[1][1] != 0 && fi.b(this.aw) - n4 == nArray[1][0] && fi.b(this.ay) - n2 == nArray[1][2]) {
            ...
            if (this.aq != null) {
                ...
                if (this.d == 2) {
                    d10 = fi.a(this.f * this.f + this.g * this.g);
                    if (d10 > 0.01) {
                        bl2 = true;
                        this.f /= d10;
                        this.g /= d10;
            ...
            aoclass ao3 = this.h(this.aw, this.ax, this.ay);
            ...
            if (this.d == 2 && (d9 = (double)fi.a(this.f * this.f + this.g * this.g)) > 0.01 && this.az * this.az + this.aB * this.aB > 0.001) {
                this.f /= d9;
                this.g /= d9;
    ...
    public aoclass a(double d2, double d3, double d4, double d5) {
        int n2;
        int n3;
        int n4 = fi.b(d2);
        ...
        if (this.as.a(n4, n3, n2) == nq.aG.bh) {
            ...
            if (nArray[0][1] != 0 && fi.b(d2 += (d6 /= d8) * d5) - n4 == nArray[0][0] && fi.b(d4 += (d7 /= d8) * d5) - n2 == nArray[0][2]) {
                d3 += (double)nArray[0][1];
            } else if (nArray[1][1] != 0 && fi.b(d2) - n4 == nArray[1][0] && fi.b(d4) - n2 == nArray[1][2]) {
    ...
    public aoclass h(double d2, double d3, double d4) {
        int n2;
        int n3;
        int n4 = fi.b(d2);
        if (this.as.a(n4, (n3 = fi.b(d3)) - 1, n2 = fi.b(d4)) == nq.aG.bh) {
