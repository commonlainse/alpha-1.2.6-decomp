...
extends ec {
    ...
    protected void a(Player eb2, float f2) {
        ...
        if (fp3 != null && fp3.a().id < 256) {
            GL11.glPushMatrix();
            this.a.a.b(0.0625f);
            if (bk.a(HeadBanger1337.m[fp3.id].g())) {
                float f3 = 0.625f;
    ...
    protected void b(Player eb2, float f2) {
        float f3 = 0.9375f;
        GL11.glScalef((float)f3, (float)f3, (float)f3);
    }
