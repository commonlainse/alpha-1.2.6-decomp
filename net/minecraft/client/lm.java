...
extends gm {
    ...
    public void a(float f2, float f3, float f4, float f5, float f6, float f7) {
        ...
        float f11 = -(TrigLookup.b(f2 * 0.6662f * 2.0f + 0.0f) * 0.4f) * f3;
        float f12 = -(TrigLookup.b(f2 * 0.6662f * 2.0f + (float)Math.PI) * 0.4f) * f3;
        float f13 = -(TrigLookup.b(f2 * 0.6662f * 2.0f + 1.5707964f) * 0.4f) * f3;
        float f14 = -(TrigLookup.b(f2 * 0.6662f * 2.0f + 4.712389f) * 0.4f) * f3;
        float f15 = Math.abs(TrigLookup.a(f2 * 0.6662f + 0.0f) * 0.4f) * f3;
        float f16 = Math.abs(TrigLookup.a(f2 * 0.6662f + (float)Math.PI) * 0.4f) * f3;
        float f17 = Math.abs(TrigLookup.a(f2 * 0.6662f + 1.5707964f) * 0.4f) * f3;
        float f18 = Math.abs(TrigLookup.a(f2 * 0.6662f + 4.712389f) * 0.4f) * f3;
        this.d.e += f11;
        this.e.e += -f11;
        this.f.e += f12;
        this.g.e += -f12;
