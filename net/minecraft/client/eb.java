...
extends hf {
    ...
    public void b(lw lw2) {
        ...
        this.e.g();
        if (lw2 != null) {
            this.az = -fi.b((this.N + this.aC) * (float)Math.PI / 180.0f) * 0.1f;
            this.aB = -fi.a((this.N + this.aC) * (float)Math.PI / 180.0f) * 0.1f;
        } else {
            this.aB = 0.0;
            this.az = 0.0;
        }
    ...
    public void a(fp fp2, boolean bl2) {
        ...
        if (bl2) {
            ...
            f2 = 0.3f;
            eo2.az = -fi.a(this.aC / 180.0f * (float)Math.PI) * fi.b(this.aD / 180.0f * (float)Math.PI) * f2;
            eo2.aB = fi.b(this.aC / 180.0f * (float)Math.PI) * fi.b(this.aD / 180.0f * (float)Math.PI) * f2;
            eo2.aA = -fi.a(this.aD / 180.0f * (float)Math.PI) * f2 + 0.1f;
            f2 = 0.02f;
