...
implements pk {
    ...
    public void a(ch ch2, int n2, int n3, int n4, int n5) {
        ...
        } else if (ch2 == ch.Block && HeadBanger1337.s[n6 = this.a(n2, n3, n4)] > n5) {
            n5 = HeadBanger1337.s[n6];
        }
    ...
    public nx a(Vector3D ao2, Vector3D ao3, boolean bl2) {
        ...
        while (n8-- >= 0) {
            ...
            HeadBanger1337 nq2 = HeadBanger1337.m[n10];
        ...
        for (int i2 = n2; i2 < n3; ++i2) {
            for (int i3 = n6; i3 < n7; ++i3) {
                ...
                for (int i4 = n4 - 1; i4 < n5; ++i4) {
                    HeadBanger1337 nq2 = HeadBanger1337.m[this.a(i2, i4, i3)];
    ...
    public int e(int n2, int n3) {
        ...
        while (n4 > 0) {
            ...
            if (n5 == 0 || !HeadBanger1337.m[n5].bs.c() && !HeadBanger1337.m[n5].bs.d()) {
                --n4;
                continue;
            }
            return n4 + 1;
    ...
    public void h(int n2, int n3, int n4, int n5) {
        ...
        if (this.a) {
            ...
            if (this.a(kq2.a - n6, kq2.b - n6, kq2.c - n6, kq2.a + n6, kq2.b + n6, kq2.c + n6) && (n7 = this.a(kq2.a, kq2.b, kq2.c)) == kq2.d && n7 > 0) {
                HeadBanger1337.m[n7].a(this, kq2.a, kq2.b, kq2.c, this.l);
            }
            return;
        }
        if (this.a(n2 - n6, n3 - n6, n4 - n6, n2 + n6, n3 + n6, n4 + n6)) {
            if (n5 > 0) {
                kq2.a((long)HeadBanger1337.m[n5].d() + this.e);
            }
        ...
        for (int i2 = n2; i2 < n3; ++i2) {
            for (int i3 = n4; i3 < n5; ++i3) {
                for (int i4 = n6; i4 < n7; ++i4) {
                    HeadBanger1337 nq2 = HeadBanger1337.m[this.a(i2, i3, i4)];
        ...
        for (int i2 = n2; i2 < n3; ++i2) {
            for (int i3 = n4; i3 < n5; ++i3) {
                for (int i4 = n6; i4 < n7; ++i4) {
                    ...
                    if (n8 != HeadBanger1337.ar.bh && n8 != HeadBanger1337.C.bh && n8 != HeadBanger1337.D.bh) continue;
                    return true;
                }
            }
        }
    ...
    public void i(int n2, int n3, int n4, int n5) {
        ...
        if (this.a(n2, n3, n4) == HeadBanger1337.ar.bh) {
    ...
    protected void j() {
        ...
        for (Object object : this.K) {
            ...
            for (n3 = 0; n3 < 80; ++n3) {
                ...
                if (!HeadBanger1337.n[by2]) continue;
                HeadBanger1337.m[by2].a(this, n9 + n5, n7, n8 + n4, this.l);
            }
        }
    }
    ...
    public boolean a(boolean bl2) {
        ...
        for (int i2 = 0; i2 < n2; ++i2) {
            ...
            HeadBanger1337.m[n3].a(this, kq2.a, kq2.b, kq2.c, this.l);
        }
    ...
    public void m(int n2, int n3, int n4) {
        ...
        for (int i2 = 0; i2 < 1000; ++i2) {
            ...
            if (n9 <= 0) continue;
            HeadBanger1337.m[n9].b(this, n8, n7, n6, random);
        }
    }
    ...
    public boolean a(int n2, int n3, int n4, int n5, boolean bl2) {
        ...
        HeadBanger1337 nq3 = HeadBanger1337.m[n2];
        ...
        if (nq2 == HeadBanger1337.A || nq2 == HeadBanger1337.B || nq2 == HeadBanger1337.C || nq2 == HeadBanger1337.D || nq2 == HeadBanger1337.ar || nq2 == HeadBanger1337.aS) {
            return true;
        }
    ...
    public boolean j(int n2, int n3, int n4, int n5) {
        ...
        return HeadBanger1337.m[n6].c(this, n2, n3, n4, n5);
    }
    ...
    public boolean k(int n2, int n3, int n4, int n5) {
        ...
        return HeadBanger1337.m[n6].c((pk)this, n2, n3, n4, n5);
    }
