...
extends BaseAI {
    ...
    protected float a(int n2, int n3, int n4) {
        if (this.as.a(n2, n3 - 1, n4) == HeadBanger1337.u.bh) {
            return 10.0f;
        }
    ...
    public boolean a() {
        ...
        return this.as.a(n4, (n3 = TrigLookup.b(this.aG.b)) - 1, n2 = TrigLookup.b(this.ay)) == HeadBanger1337.u.bh && this.as.j(n4, n3, n2) > 8 && super.a();
    }
